...
<svelte:head>
	<title>Create account · Water Security Toolbox</title>
</svelte:head>

<AuthDismissShell labelledBy="register-title">
	{#if checkEmail}
		<span class="font-mono text-[11px] uppercase tracking-[0.2em] text-diagnose">Check your email</span>
		<h1 id="register-title" class="mt-2 font-display text-2xl text-ink">Verify to continue</h1>
	...
	{:else}
		...
		<h1 id="register-title" class="mt-2 font-display text-2xl text-ink">Create an account</h1>
